  ...
  return (
    <div className="flex p-7  flex-col items-center justify-center   w-full min-h-[500px] max-h-[700px] h-screen">
      ...
      <div className=" w-full    relative  flex flex-col items-center justify-center">
        ...
        <p
          className=" ml-2 mb-2 mt-5 sm:mt-10 text-gray-900 text-xs bg-gray-100 p-1 font-bold sm:text-lg text-center sm:p-3 rounded-full  font-Krona"
          style={{ boxShadow: "4px 4px 10px rgba(0, 0, 0, 1)" }}
        >
